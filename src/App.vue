...
<template>
  <header>
    <div class="container">
      <div class="title">HITCON 2023 Issue 小精靈</div>
      <p>幫你開 Issue 的小精靈</p>
    </div>
  </header>
  <div class="container">
  ...
  methods: {
    updateLinks() {
      ...
      for (let [group, assignUsers] of Object.entries(this.groupList)) {
        ...
        description = `/label "Status::Inbox" "Team::${group}"\n` + description

        let link = new URL('https://gitlab.com/HacksInTaiwan/2023/board/-/issues/new')
